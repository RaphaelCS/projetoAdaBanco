...
import tech.ada.banco.service.ContaCorrentePJService;
...
@RestController
@RequestMapping("/clientesPJ/contaCorrente")
@RequiredArgsConstructor
public class ContaCorrentePJController {

    private final ContaCorrentePJService service;
